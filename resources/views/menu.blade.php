<div class="d-md-none">
    <a class="navbar-brand ml-0" href="{{ route( (Auth::check() && Auth::user()->role == 'admin')? 'back_page.show' : 'page.show', 'accueil') }}" id="sm-logo"><img src="/images/logo_example_400.png" alt="logo"></a>
</div>
<nav class="navbar navbar-expand-md">
  ...
  <div class="collapse navbar-collapse mr-auto" id="navbars01">
    <a class="navbar-brand ml-0 d-none d-md-block" href="{{ route( (Auth::check() && Auth::user()->role == 'admin')? 'back_page.show' : 'page.show', 'accueil') }}" id="logo"><img src="/images/logo_example_400.png" alt="logo"></a>
