...
Route::group(array('prefix' => 'coulisses', 'middleware' => ['auth']), function () {
  ...
  Route::post('destroyinsertedrubrique/{id}', 'TypeController@destroyInsertedRubrique')->middleware('ajax');
  Route::get('getdestroyinsertedrubrique/{id}', 'TypeController@destroyInsertedRubrique')->name('type.destroyInsert');
