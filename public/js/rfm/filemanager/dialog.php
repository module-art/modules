...
<html>
    <head>
        ...
        <link rel="stylesheet" href="localized_cdn/jplayer.blue.monday.min.css" />
        <link rel="stylesheet" href="localized_cdn/tui-image-editor.css">
        ...
        <script src="localized_cdn/jquery-1.12.4.min.js"></script>
        <script src="localized_cdn/jquery-ui.min.js"></script>
        <script src="js/plugins.js?v=<?php echo $version; ?>"></script>
        <script src="localized_cdn/jquery.jplayer.min.js"></script>
        <link type="text/css" href="localized_cdn/tui-color-picker.css" rel="stylesheet">
        <script type="text/javascript" src="localized_cdn/fabric.js"></script>
        <script type="text/javascript" src="localized_cdn/tui-code-snippet.min.js"></script>
        <script type="text/javascript" src="localized_cdn/FileSaver.min.js"></script>
        <script type="text/javascript" src="localized_cdn/tui-color-picker.js"></script>
        <script src="localized_cdn/tui-image-editor.js"></script>
