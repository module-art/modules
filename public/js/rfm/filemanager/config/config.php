...
| <input type="button" href="../filemanager/dialog.php?field_id=imgField&lang=en_EN&akey=fsUn8A5u9e6UypkZ" value="Files">
...
$config = array(
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => '../../../storage/'.$theme.'/rfm_thumbs/',
	...
	*/
	...
	'ext_video'                               => array( 'mp4', "webm" ), //Video 'mov', 'mpeg', 'm4v',  'avi', 'mpg', 'wma', "flv",
