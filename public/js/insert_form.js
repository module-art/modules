...
/***/ "./resources/assets/common/js/insert_form.js":
/*!***************************************************!*\
  !*** ./resources/assets/common/js/insert_form.js ***!
  \***************************************************/
...
$(document).ready(function () {
  var current_theme = 'grands_chemins'; //galleries
  ...
  function listenToInsertGallery() {
    $('#insert-gallery').click(function () {
      var $galleryData = new FormData($('#gallery_form')[0]),
          $isRound = parseInt($galleryData.get('round_border')); //alert($galleryData.get('round_border'));
  ...
  var tinyconf = {
    ...
    ///composants/rfm/filemanager/plugin.min.js
  ...
  tinyconf_small.height = 100; //tinyconf_small.toolbar1 =  "formatselect | bold italic | link unlink | subscript superscript | paste code";
...
/***/ 3:
/*!*********************************************************!*\
  !*** multi ./resources/assets/common/js/insert_form.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/sylvestre/www/modules/modules-chemins/resources/assets/common/js/insert_form.js */"./resources/assets/common/js/insert_form.js");
